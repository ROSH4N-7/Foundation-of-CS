1) CREATE TABLE Student (
    ...
    Email VARCHAR(100));
- I created a table student to store student name once.

2) CREATE TABLE Club (
    ClubName VARCHAR(50) PRIMARY KEY,
    ClubRoom VARCHAR(10),
    ClubMentor VARCHAR(50));
- I created a table club to store club info only once.

3) CREATE TABLE Membership (
    StudentID INT,
    ClubName VARCHAR(50),
    JoinDate DATE,
...
- Inserted values in Student table.

5) INSERT INTO Club VALUES 
('Music Club', 'R101', 'Mr. Raman'),
('Sports Club', 'R202', 'Ms. Sita'),
('Drama Club', 'R303', 'Mr. Kiran'),
('Coding Club', 'Lab1', 'Mr. Anil');
- Inserted club values in Club table.

6) INSERT INTO Membership VALUES
...
- Inserted values in Membership table.
